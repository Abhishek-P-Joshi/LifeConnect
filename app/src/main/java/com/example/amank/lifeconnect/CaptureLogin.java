...
public class CaptureLogin extends LoginActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapturePicture = (Button) findViewById(R.id.btnCapturePictureLogin);
    ...
    private void launchUploadActivity(boolean isImage){
        Intent i = new Intent(CaptureLogin.this, UploadLogin.class);
